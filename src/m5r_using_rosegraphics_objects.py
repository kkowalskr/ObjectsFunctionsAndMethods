...
#                get_bounding_box, __init__, and clone
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center, radius, and fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            It will draw all objects on the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When you do not want the rest of the code to run before closing
#             the window. Without close_on_mouse_click the rest of the code
#               will run and other windows may pop up on top of it.
#
